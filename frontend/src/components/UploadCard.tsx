...
export const UploadCard: React.FC = () => {
  ...
  return (
    <>
      <div
        className="border border-gray-200 bg-white rounded-md flex flex-col overflow-hidden hover:cursor-pointer"
        onClick={handleCardClick}
      >
        <img
          src="https://www.theforage.com/blog/wp-content/uploads/2023/05/google-interview-questions.jpg"
          alt=""
          className="h-36"
        />
        <div className="flex flex-col gap-2 p-3">
          <h3 className="font-semibold">Tiffany Luo JTBD Interview</h3>
          <div className="flex justify-between text-xs text-gray-500">
            <span>July 9th, 2024</span>
            <span>#userinterview</span>
          </div>
        </div>
      </div>
      ...
      <UploadModal isVisible={isModalVisible} onClose={handleCloseModal}>
        <div className="flex flex-col gap-8 p-12">
          ...
          <div className="flex flex-col gap-4">
            <h2 className="text-3xl font-medium">Tiffany Luo JTBD Interview</h2>
            <div className="flex flex-col gap-3">
              ...
              <p className="text-sm">
                ...
                Malorum", written by Cicero in 45 BC "At vero eos et accusamus
